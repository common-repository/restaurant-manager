...
- Fixed a bug with the reservation scheduler.  The times are correctly set for open times.
- If no day is set then the time will not be able to be selected for this day.

**Version 1.3.3**

- Updated the text and language domain to assist translations.

**Version 1.3.2**

- Fixed the delete schedule error for Firefox, safari and opera.
